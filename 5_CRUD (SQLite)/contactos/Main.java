        ...
        do {
            ...
            switch (opt) {
                case 1:
                    ...
                    System.out.println("ID" + "\t" + "NAME" + "\t" + "SEX" + "\t" + "NATIONALITY" + "\t" + "AGE");
                    for (Person d : data.list("")) {
                        System.out.println(d.getId() + "\t" + d.getName() + "\t" + d.getSex() + "\t" + d.getNationality() + "\t" + "\t" + d.getAge());
                    }
                    break;
                case 2:
                    ...
                    p.setNationality(input.nextLine());
                    ...
                    do {
                        ...
                        try {
                            ...
                            if (d != null) {
                                ...
                                System.out.println("Nationality: " + d.getNationality());
                ...
                case 5:
                    ...
                    if (per != null) {
                        ...
                        System.out.println("Nationality current: " + per.getNationality());
                        ...
                        per.setNationality(input.nextLine());

                        System.out.print("new edad: ");
                        try {
